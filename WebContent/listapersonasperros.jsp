...
<%@ page import="examples.perro.persona.Persona, java.util.List, examples.perro.persona.Perro" %>   
...
lista_personas_perros.add(new Persona(31, "Tamara",new Perro("Jacko", "Golden")));
